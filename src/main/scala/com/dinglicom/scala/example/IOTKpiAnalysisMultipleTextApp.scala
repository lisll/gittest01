...
import com.dinglicom.scala.example.multiple.FlinkMultipleTextOutputFormat
 ...
 */
object IOTKpiAnalysisMultipleTextApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val jc = new JobConf()
    FileOutputFormat.setOutputPath(jc, new Path("hdfs://nameservice1/tmp/test/flink_out91"))
