package com.dinglicom.scala.demo.datastream.sink.mysql
...
import com.dinglicom.scala.demo.datastream.trigger.CustomProcessTimeTrigger

/**
  * <p/>
  * <li>Description: kafka数据源写入mysql数据库</li>
  * <li>@author: wubo</li>
  * <li>Date: 2020-02-24 13:12</li>
  *  需要手动建表（不建表,未报错）
  */
object Kafka2Mysql {
  ...
  class CustomJdbcSink extends RichSinkFunction[Int] {
    ...
    override def open(parameters: Configuration): Unit = {
      ...
      conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/flink_demo?user=root&password=root&serverTimezone=GMT%2B8", "root", "root")
