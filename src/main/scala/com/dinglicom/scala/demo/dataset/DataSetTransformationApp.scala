...
import com.dinglicom.scala.demo.utils.DBUtils
...
/**
  * <p/>Transformation算子转换操作(filter、map、flatMap、distinct、join等)
  * <li>Description: Transformation</li>
  * <li>@author: wubo</li>
  * <li>Date: 2020/02/11 14:33</li>
  */
object DataSetTransformationApp {
  ...
  def crossFunction(env: ExecutionEnvironment): Unit = {
    val info1 = List("苏大强", "苏乞儿")
    val info2 = List(13, 1, 0)
  ...
  def firstFunction(env: ExecutionEnvironment): Unit = {
    ...
    info.append((1, "AHadoop"));
    info.append((1, "BSpark"));
    info.append((1, "CFlink"));
    info.append((2, "Java"));
    ...
    data.groupBy(0).sortGroup(1, Order.DESCENDING).first(3).print()
  }
