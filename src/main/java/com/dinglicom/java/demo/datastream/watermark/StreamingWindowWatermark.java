package com.dinglicom.java.demo.datastream.watermark;
...
public class StreamingWindowWatermark {
	...
	public static void main(String[] args) throws Exception {
        ...
        FlinkKafkaConsumer<String> myConsumer = new FlinkKafkaConsumer<String>("fk_string_topic", new SimpleStringSchema(), props);
        ...
        //注意：由于getSideOutput方法是SingleOutputStreamOperator子类中特有的方法，所以这里的类型不能使用它的父类datastream
        ...
        //SingleOutputStreamOperator<String> window = waterMarkStream.keyBy(0)
                ...
                //.allowedLateness(Time.seconds(2)) //允许数据延迟2秒
        ...
        //把迟到的数据暂时打印到控制台，实际中可以保存到其它存储介质中
